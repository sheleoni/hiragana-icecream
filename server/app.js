...
const initialIceCreamScoops = [];
const initialTideLevel = {
    // hiragana
    "あ": 0,
    "い": 0,
    "う": 0,
...
client.connect().then(() => {
    ...
    app.get('/reset', (req, res) => {
        ...
        collection.findOneAndUpdate(
            ...
            {
                $set: {
                    characterScores: initialCharacterScores,
                    iceCreamScoops: initialIceCreamScoops,
                    tideLevel: initialTideLevel
                }
            },
            { returnOriginal: false } // This option will return the updated document
        )
            .then(result => {
    ...
    app.post('/setIceCreamScoop', (req, res) => {
        ...
        const iceCreamScoopsData = req.body.iceCreamScoops;

        // Find the document and update it
        collection.findOneAndUpdate(
            { _id: new ObjectId(process.env.SAMPLE_OBJ_ID) },
            { $set: { iceCreamScoops: iceCreamScoopsData } },
